          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6 text-brand-text/70 leading-relaxed">
                ...
                <p>
                  Сегодня «Медовар» — это современная пасека, расположенная в
                  экологически чистом районе, вдали от шумных городов и
                  промышленных зон. Мы бережно собираем мёд, сохраняя все его
                  полезные свойства и неповторимый аромат диких трав и цветов.
                </p>
                <p>
                  Мы не используем термическую обработку, искусственные добавки
                  или сиропы. Наш мёд — это именно то, что создали пчёлы.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-white/60">
              Принципы, которым мы следуем в каждом деле
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={idx} className="relative">
                <div
                  className="text-6xl font-black text-brand-primary/4
                0 mb-4"
                >
                  {step.num}
                </div>
